...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251213203125_20251213_PartnerEnhancements') THEN
    ALTER TABLE "Partners" ADD "BusinessHoursJson" text;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251213203125_20251213_PartnerEnhancements') THEN
    ALTER TABLE "Partners" ADD "ContactJson" text;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251213203125_20251213_PartnerEnhancements') THEN
    ALTER TABLE "Partners" ADD "ImageUrlsJson" text;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251213203125_20251213_PartnerEnhancements') THEN
    ALTER TABLE "Partners" ADD "IntegrationJson" text;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251213203125_20251213_PartnerEnhancements') THEN
    ALTER TABLE "Partners" ADD "IsVerified" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251213203125_20251213_PartnerEnhancements') THEN
    ALTER TABLE "Partners" ADD "RatingAvg" numeric;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251213203125_20251213_PartnerEnhancements') THEN
    ALTER TABLE "Partners" ADD "RatingCount" integer;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251213203125_20251213_PartnerEnhancements') THEN
    ALTER TABLE "Partners" ADD "TagsJson" text;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251213203125_20251213_PartnerEnhancements') THEN
    ALTER TABLE "Partners" ADD "VerificationBadge" character varying(128);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251213203125_20251213_PartnerEnhancements') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20251213203125_20251213_PartnerEnhancements', '8.0.0');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251213210506_20251213_PartnerPhotos') THEN
    CREATE TABLE "PartnerPhotos" (
        ...
        CONSTRAINT "PK_PartnerPhotos" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_PartnerPhotos_Partners_PartnerId" FOREIGN KEY ("PartnerId") REFERENCES "Partners" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251213210506_20251213_PartnerPhotos') THEN
    CREATE INDEX "IX_PartnerPhotos_PartnerId" ON "PartnerPhotos" ("PartnerId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251213210506_20251213_PartnerPhotos') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20251213210506_20251213_PartnerPhotos', '8.0.0');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251214002854_AddProtectionPlan') THEN
    ALTER TABLE "Bookings" ADD "ProtectionAmount" numeric(18,2);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251214002854_AddProtectionPlan') THEN
    ALTER TABLE "Bookings" ADD "ProtectionPlanId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251214002854_AddProtectionPlan') THEN
    ALTER TABLE "Bookings" ADD "ProtectionSnapshotJson" text;
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE "ProtectionPlans" (
        ...
        "Name" character varying(128) NOT NULL,
        "Description" character varying(512),
        "PricingMode" character varying(32) NOT NULL,
        "DailyPrice" numeric(18,2) NOT NULL,
        "FixedPrice" numeric(18,2) NOT NULL,
        "MinFee" numeric(18,2) NOT NULL,
        "MaxFee" numeric(18,2) NOT NULL,
        "Currency" character varying(8) NOT NULL,
        "IncludesMinorDamageWaiver" boolean NOT NULL,
        "MinorWaiverCap" numeric,
        "Deductible" numeric,
        "ExcludesJson" text,
        "IsMandatory" boolean NOT NULL,
        "IsDefault" boolean NOT NULL,
        "IsActive" boolean NOT NULL,
        CONSTRAINT "PK_ProtectionPlans" PRIMARY KEY ("Id")
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251214002854_AddProtectionPlan') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20251214002854_AddProtectionPlan', '8.0.0');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215181156_AddOwnerBioColumn') THEN
    ALTER TABLE "Vehicles" ADD "AvailableFrom" timestamp without time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215181156_AddOwnerBioColumn') THEN
    ALTER TABLE "Vehicles" ADD "AvailableUntil" timestamp without time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215181156_AddOwnerBioColumn') THEN
    ALTER TABLE "Vehicles" ADD "InsuranceDocumentUrl" text;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215181156_AddOwnerBioColumn') THEN
    ALTER TABLE "Vehicles" ADD "RoadworthinessDocumentUrl" text;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215181156_AddOwnerBioColumn') THEN
    ALTER TABLE "OwnerProfiles" ADD "Bio" character varying(1024);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215181156_AddOwnerBioColumn') THEN
    ALTER TABLE "OwnerProfiles" ADD "BusinessRegistrationNumberPending" character varying(128);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215181156_AddOwnerBioColumn') THEN
    ALTER TABLE "OwnerProfiles" ADD "CompanyNamePending" character varying(256);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215181156_AddOwnerBioColumn') THEN
    ALTER TABLE "OwnerProfiles" ADD "CompanyVerificationStatus" character varying(32) NOT NULL DEFAULT '';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215181156_AddOwnerBioColumn') THEN
    ALTER TABLE "OwnerProfiles" ADD "PayoutDetailsPendingJson" text;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215181156_AddOwnerBioColumn') THEN
    ALTER TABLE "OwnerProfiles" ADD "PayoutVerificationStatus" character varying(32) NOT NULL DEFAULT '';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215181156_AddOwnerBioColumn') THEN
    ALTER TABLE "Bookings" ADD "GuestEmail" character varying(256);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215181156_AddOwnerBioColumn') THEN
    ALTER TABLE "Bookings" ADD "GuestFirstName" character varying(128);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215181156_AddOwnerBioColumn') THEN
    ALTER TABLE "Bookings" ADD "GuestLastName" character varying(128);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215181156_AddOwnerBioColumn') THEN
    ALTER TABLE "Bookings" ADD "GuestPhone" character varying(32);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215181156_AddOwnerBioColumn') THEN
    ALTER TABLE "Bookings" ADD "GuestUserId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215181156_AddOwnerBioColumn') THEN
    CREATE TABLE "ProfileChangeAudits" (
        "Id" uuid NOT NULL,
        "UserId" uuid NOT NULL,
        ...
        "CreatedAt" timestamp without time zone NOT NULL,
        CONSTRAINT "PK_ProfileChangeAudits" PRIMARY KEY ("Id")
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215181156_AddOwnerBioColumn') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20251215181156_AddOwnerBioColumn', '8.0.0');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251215231736_AddOwnerProfileBio') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20251215231736_AddOwnerProfileBio', '8.0.0');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251217053550_AddMileageChargingFields') THEN
    ALTER TABLE "Vehicles" ADD "IncludedKilometers" integer NOT NULL DEFAULT 0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251217053550_AddMileageChargingFields') THEN
    ALTER TABLE "Vehicles" ADD "MileageChargingEnabled" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251217053550_AddMileageChargingFields') THEN
    ALTER TABLE "Vehicles" ADD "PricePerExtraKm" numeric NOT NULL DEFAULT 0.0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251217053550_AddMileageChargingFields') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20251217053550_AddMileageChargingFields', '8.0.0');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251218134532_CreateDocumentsTableFromModel') THEN
    ALTER TABLE "OwnerProfiles" ADD COLUMN IF NOT EXISTS "PayoutVerificationStatus" character varying(32) NOT NULL DEFAULT '';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251218134532_CreateDocumentsTableFromModel') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20251218134532_CreateDocumentsTableFromModel', '8.0.0');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251219202849_AddNotificationPreferences') THEN
    ALTER TABLE "Vehicles" ADD "DailyRate" numeric(18,2);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251219202849_AddNotificationPreferences') THEN
    ALTER TABLE "Users" ADD "NotificationPreferencesJson" text;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251219202849_AddNotificationPreferences') THEN
    ALTER TABLE "OwnerProfiles" ADD "NotificationPreferencesJson" text;
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE "NotificationJobs" (
        ...
        "BookingId" uuid,
        "TargetUserId" uuid,
        "TargetEmail" character varying(256),
        "TargetPhone" character varying(32),
        "ChannelsJson" text NOT NULL,
        "Subject" character varying(256) NOT NULL,
        "Message" text NOT NULL,
        "TemplateName" character varying(128),
        "MetadataJson" text,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251219202849_AddNotificationPreferences') THEN
    CREATE INDEX "IX_Bookings_ProtectionPlanId" ON "Bookings" ("ProtectionPlanId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251219202849_AddNotificationPreferences') THEN
    CREATE INDEX "IX_NotificationJobs_ScheduledAt" ON "NotificationJobs" ("ScheduledAt");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251219202849_AddNotificationPreferences') THEN
    CREATE INDEX "IX_NotificationJobs_Status" ON "NotificationJobs" ("Status");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251219202849_AddNotificationPreferences') THEN
    ALTER TABLE "Bookings" ADD CONSTRAINT "FK_Bookings_ProtectionPlans_ProtectionPlanId" FOREIGN KEY ("ProtectionPlanId") REFERENCES "ProtectionPlans" ("Id");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251219202849_AddNotificationPreferences') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20251219202849_AddNotificationPreferences', '8.0.0');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    ALTER TABLE "OwnerProfiles" ADD "InstantWithdrawalEnabled" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    ALTER TABLE "OwnerProfiles" ADD "MinimumPayoutAmount" numeric NOT NULL DEFAULT 0.0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    ALTER TABLE "OwnerProfiles" ADD "PayoutFrequency" character varying(32) NOT NULL DEFAULT '';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    ALTER TABLE "Bookings" ADD "ActualPickupDateTime" timestamp without time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    ALTER TABLE "Bookings" ADD "PostTripFuelLevel" double precision;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    ALTER TABLE "Bookings" ADD "PostTripNotes" text;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    ALTER TABLE "Bookings" ADD "PostTripOdometer" integer;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    ALTER TABLE "Bookings" ADD "PostTripPhotosJson" text;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    ALTER TABLE "Bookings" ADD "PostTripRecordedAt" timestamp without time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    ALTER TABLE "Bookings" ADD "PostTripRecordedBy" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    ALTER TABLE "Bookings" ADD "PreTripFuelLevel" double precision;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    ALTER TABLE "Bookings" ADD "PreTripNotes" text;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    ALTER TABLE "Bookings" ADD "PreTripOdometer" integer;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    ALTER TABLE "Bookings" ADD "PreTripPhotosJson" text;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    ALTER TABLE "Bookings" ADD "PreTripRecordedAt" timestamp without time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    ALTER TABLE "Bookings" ADD "PreTripRecordedBy" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    CREATE TABLE "InstantWithdrawals" (
        "Id" uuid NOT NULL,
        "OwnerId" uuid NOT NULL,
        "Amount" numeric NOT NULL,
        ...
        "Status" character varying(32) NOT NULL,
        "Method" character varying(32) NOT NULL,
        "ExternalTransferId" character varying(256),
        "Reference" character varying(256),
        "PayoutDetailsJson" text,
        "ErrorMessage" text,
        "CreatedAt" timestamp without time zone NOT NULL,
        "ProcessedAt" timestamp without time zone,
        "CompletedAt" timestamp without time zone,
        CONSTRAINT "PK_InstantWithdrawals" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_InstantWithdrawals_Users_OwnerId" FOREIGN KEY ("OwnerId") REFERENCES "Users" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    CREATE TABLE "RefundAuditLogs" (
        "Id" uuid NOT NULL,
        "DepositRefundId" uuid NOT NULL,
        "Action" character varying(64) NOT NULL,
        "OldStatus" character varying(32) NOT NULL,
        "NewStatus" character varying(32) NOT NULL,
        "PerformedByUserId" uuid,
        "Notes" text,
        "MetadataJson" text,
        "CreatedAt" timestamp without time zone NOT NULL,
        CONSTRAINT "PK_RefundAuditLogs" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_RefundAuditLogs_DepositRefunds_DepositRefundId" FOREIGN KEY ("DepositRefundId") REFERENCES "DepositRefunds" ("Id") ON DELETE CASCADE,
        CONSTRAINT "FK_RefundAuditLogs_Users_PerformedByUserId" FOREIGN KEY ("PerformedByUserId") REFERENCES "Users" ("Id")
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    CREATE INDEX "IX_DepositRefunds_BookingId" ON "DepositRefunds" ("BookingId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    CREATE INDEX "IX_DepositRefunds_ProcessedByUserId" ON "DepositRefunds" ("ProcessedByUserId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    CREATE INDEX "IX_InstantWithdrawals_OwnerId" ON "InstantWithdrawals" ("OwnerId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    CREATE INDEX "IX_RefundAuditLogs_DepositRefundId" ON "RefundAuditLogs" ("DepositRefundId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    CREATE INDEX "IX_RefundAuditLogs_PerformedByUserId" ON "RefundAuditLogs" ("PerformedByUserId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251221023231_AddTripStartCompleteFields') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20251221023231_AddTripStartCompleteFields', '8.0.0');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251222180451_AddCapturedAmountAndIsActiveColumns') THEN
    ALTER TABLE "PaymentTransactions" ADD "CapturedAmount" numeric(18,2);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251222180451_AddCapturedAmountAndIsActiveColumns') THEN
    ALTER TABLE "CarCategories" ADD "IsActive" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE "PayoutAuditLogs" (
        ...
        "Notes" text,
        "CreatedAt" timestamp without time zone NOT NULL,
        CONSTRAINT "PK_PayoutAuditLogs" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_PayoutAuditLogs_Payouts_PayoutId" FOREIGN KEY ("PayoutId") REFERENCES "Payouts" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251222180451_AddCapturedAmountAndIsActiveColumns') THEN
    CREATE INDEX "IX_PayoutAuditLogs_PayoutId" ON "PayoutAuditLogs" ("PayoutId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251222180451_AddCapturedAmountAndIsActiveColumns') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20251222180451_AddCapturedAmountAndIsActiveColumns', '8.0.0');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251224055013_AddEmailTemplates') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251224055013_AddEmailTemplates') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20251224055013_AddEmailTemplates', '8.0.0');
    END IF;
END $EF$;
COMMIT;
