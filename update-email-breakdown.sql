...
-- Includes: Vehicle rental, Driver, Protection Plan, Service Fee, Security Deposit, Promo Discount
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 40px 30px; text-align: center;">
                            <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: bold;">🔖 Booking Reserved!</h1>
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            <h3 style="margin: 0 0 20px 0; color: #333; font-size: 18px; border-bottom: 2px solid #667eea; padding-bottom: 10px;">👤 Customer Details</h3>
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                    ...
                    <tr>
                        <td style="padding: 0 30px 30px 30px;">
                            <h3 style="margin: 0 0 20px 0; color: #333; font-size: 18px; border-bottom: 2px solid #667eea; padding-bottom: 10px;">🚗 Vehicle Details</h3>
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                    ...
                    <tr>
                        <td style="padding: 0 30px 30px 30px;">
                            <h3 style="margin: 0 0 20px 0; color: #333; font-size: 18px; border-bottom: 2px solid #667eea; padding-bottom: 10px;">📅 Trip Details</h3>
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                    ...
                    <tr>
                        <td style="padding: 0 30px 30px 30px;">
                            <h3 style="margin: 0 0 20px 0; color: #333; font-size: 18px; border-bottom: 2px solid #667eea; padding-bottom: 10px;">💰 Pricing Breakdown</h3>
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; border-radius: 8px; overflow: hidden;">
                                ...
                                <tr>
                                    <td style="padding: 12px 20px; color: #666; border-bottom: 1px solid #e0e0e0;">🛡️ Protection Plan</td>
                                ...
                                <tr>
                                    <td style="padding: 12px 20px; color: #666; border-bottom: 1px solid #e0e0e0;">📊 Service Fee</td>
                                ...
                                <tr>
                                    <td style="padding: 12px 20px; color: #666; border-bottom: 2px solid #667eea;">🔒 Security Deposit (Refundable)</td>
                                ...
                                <tr style="display: {{promo_display}};">
                                    <td style="padding: 12px 20px; color: #27ae60; border-bottom: 2px solid #667eea;">🎁 Promo Discount</td>
                            ...
                            <p style="margin: 10px 0 0 0; color: #999; font-size: 13px; font-style: italic;">✓ Includes {{currency}} {{deposit_amount}} refundable security deposit</p>
                        </td>
                    </tr>
...
WHERE "TemplateCode" = 'booking_reserved' OR "TemplateCode" = 'booking_confirmation_customer';
        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            <h3 style="margin: 0 0 20px 0; color: #333; font-size: 18px; border-bottom: 2px solid #2d7d5d; padding-bottom: 10px;">🚗 Vehicle Details</h3>
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding: 8px 0; color: #666;">Vehicle:</td>
                                    <td style="padding: 8px 0; color: #333; font-weight: bold; text-align: right;">{{vehicle_make}} {{vehicle_model}}</td>
                    ...
                    <tr>
                        <td style="padding: 0 30px 30px 30px;">
                            <h3 style="margin: 0 0 20px 0; color: #333; font-size: 18px; border-bottom: 2px solid #2d7d5d; padding-bottom: 10px;">📅 Trip Details</h3>
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding: 8px 0; color: #666;">Pickup:</td>
                                    <td style="padding: 8px 0; color: #333; font-weight: bold; text-align: right;">{{pickup_date}} at {{pickup_time}}</td>
                    ...
                    <tr>
                        <td style="padding: 0 30px 30px 30px;">
                            <h3 style="margin: 0 0 20px 0; color: #333; font-size: 18px; border-bottom: 2px solid #2d7d5d; padding-bottom: 10px;">💳 Payment Summary</h3>
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8fffe; border-radius: 8px; overflow: hidden;">
                                ...
                                <tr>
                                    <td style="padding: 12px 20px; color: #666; border-bottom: 1px solid #d1f2e8;">🛡️ Protection Plan</td>
                                ...
                                <tr>
                                    <td style="padding: 12px 20px; color: #666; border-bottom: 1px solid #d1f2e8;">📊 Service Fee</td>
                                ...
                                <tr>
                                    <td style="padding: 12px 20px; color: #666; border-bottom: 2px solid #2d7d5d;">🔒 Security Deposit (Refundable)</td>
                                ...
                                <tr style="display: {{promo_display}};">
                                    <td style="padding: 12px 20px; color: #27ae60; border-bottom: 2px solid #2d7d5d;">🎁 Promo Discount</td>
                    ...
                    <tr>
                        <td style="padding: 0 30px 30px 30px;">
                            <h3 style="margin: 0 0 20px 0; color: #333; font-size: 18px; border-bottom: 2px solid #2d7d5d; padding-bottom: 10px;">🏠 Owner Details</h3>
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding: 8px 0; color: #666;">Name:</td>
                            ...
                            <div style="margin-top: 15px; background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 12px; border-radius: 4px;">
                                <p style="margin: 0; color: #856404; font-size: 14px;"><strong>📍 Pickup Instructions:</strong></p>
